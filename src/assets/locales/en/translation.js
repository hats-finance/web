export const translationEN = {
  ...
  "#HelloHatterDescription": "Welcome to Hats.Finance, a decentralized bug bounty protocol that allows everyone to add liquidity to bug bounties while farming $HATS.  Hackers can responsibly disclose vulnerabilities without KYC & be rewarded with the highest prizes.",
