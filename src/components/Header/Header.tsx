...
export default function Header() {
  ...
  const links = (
    <div className="links-wrapper">
      <NavLink to={RoutePaths.AuditFirms} onClick={() => setToggleMenu(false)} activeClassName="selected">
        {t("Header.auditFirms")}
      </NavLink>
      <NavLink to={RoutePaths.Challenges} onClick={() => setToggleMenu(false)} activeClassName="selected">
        {t("Header.challenges")}
      </NavLink>
      ...
      <a target="_blank" rel="noopener noreferrer" href={GIT_BOOK}>
        {t("Docs")}
      </a>
      <a target="_blank" rel="noopener noreferrer" href={SocialLinks.Discord}>
        {t("Community")}
      </a>
      <button onClick={() => window.open(DAPP_LINK, "_blank")} className="button fill">
        {t("App")}
      </button>
      {screenSize === ScreenSize.Mobile && (
        <>
          ...
          <a target="_blank" rel="noopener noreferrer" href={COOKIES_POLICY}>
            {t("Cookies Policy")}
          </a>
        </>
      )}
  ...
  return (
    <div className="header-wrapper">
      ...
      {screenSize === ScreenSize.Desktop ? (
        ...
        <img
          src={require(toggleMenu ? "../../assets/icons/close.svg" : "../../assets/icons/menu.svg").default}
